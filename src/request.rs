...
pub struct Request {
    ...
    pub body: Vec<u8>,
    /// The http version. Note: RustHTTPServer only supporst 1.1 at the moment
    pub http_version: String,
    /// The request method (GET, POST, PUT etc). Method should always be fully capitalized.
    pub method: String,
    /// Contains all the request headers. These are always all lower-case in RustHTTPServer
    ///
